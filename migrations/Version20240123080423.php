 ...
 */
final class Version20240123080423 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE informe (id INT AUTO_INCREMENT NOT NULL, imagen VARCHAR(255) NOT NULL, observaciones VARCHAR(255) DEFAULT NULL, recaudacion INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_tour (id INT AUTO_INCREMENT NOT NULL, cod_user_id INT NOT NULL, cod_tour_id INT NOT NULL, INDEX IDX_1050B5A035D62301 (cod_user_id), INDEX IDX_1050B5A087557DD7 (cod_tour_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE visita (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, descripcion VARCHAR(255) NOT NULL, foto VARCHAR(255) NOT NULL, gps VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE ruta ADD cod_localidad_id INT NOT NULL, ADD nombre VARCHAR(255) NOT NULL, ADD descripcion VARCHAR(255) NOT NULL, ADD foto VARCHAR(255) NOT NULL, ADD punto_inicio VARCHAR(255) NOT NULL, ADD horario JSON NOT NULL COMMENT \'(DC2Type:json)\'');
        $this->addSql('ALTER TABLE ruta ADD CONSTRAINT FK_C3AEF08C4DAAACCE FOREIGN KEY (cod_localidad_id) REFERENCES localidad (id)');
        $this->addSql('CREATE INDEX IDX_C3AEF08C4DAAACCE ON ruta (cod_localidad_id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE ruta DROP FOREIGN KEY FK_C3AEF08C4DAAACCE');
        ...
        $this->addSql('DROP INDEX IDX_C3AEF08C4DAAACCE ON ruta');
        $this->addSql('ALTER TABLE ruta DROP cod_localidad_id, DROP nombre, DROP descripcion, DROP foto, DROP punto_inicio, DROP horario');
    }
}
